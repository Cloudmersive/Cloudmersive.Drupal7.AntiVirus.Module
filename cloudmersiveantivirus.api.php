...
/**
 * Alter whether a file should be scanned by .
 *
 * The CloudmersiveAntivirus anti-virus scanner.
 *
 ...
 */
function hook_cloudmersiveantivirus_file_is_scannable($file) {
  // Don't scan image files.
  if ($mime_type = $file->filemime) {
